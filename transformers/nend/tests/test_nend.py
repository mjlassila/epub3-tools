...
# ===============
    ...
    def test_packdoc_valid(self): 
        ...
        valid_packdoc_fn = os.path.join(self.testfiles_dir, 'good.nav.html')
    ...
    def test_packdoc_not_valid_rnc(self): 
        ...
        not_valid_packdoc_fn = os.path.join(self.testfiles_dir, 'invalid.nav.rnc.html')
    ...
    def test_packdoc_not_valid_sch(self): 
        ...
        not_valid_packdoc_fn = os.path.join(self.testfiles_dir, 'invalid.nav.sch.html')
        not_valid = etree.parse(not_valid_packdoc_fn)
        assert(not(nend.validate(not_valid)))
    ...
    def test_packdoc_all_invalid(self):
        ...
        smoketests_dir = os.path.join(self.testfiles_dir, 'invalid', 'nav')
        for end_fn in glob.glob(smoketests_dir + '/*.html'):
            not_valid = etree.parse(end_fn)
            assert(not(nend.validate(not_valid)))
    ...
    def test_packdoc_all_valid(self):
        ...
        smoketests_dir = os.path.join(self.testfiles_dir, 'valid', 'nav')
        for end_fn in glob.glob(smoketests_dir + '/*.html'):
            valid = etree.parse(end_fn)
            assert(nend.validate(valid))
